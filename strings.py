    ...
    def InitAsEnglish(self):
        ...
        self.strings = {
            ...
            'MenuItems': {
                ...
                121: 'Check if any updates for Miyamoto! Next are available to download',
                ...
                130: 'Export .szs Using YAZ0COMP.exe',
                131: 'Compress (Linux users must have WINE installed.',
                132: 'Convert SARC Archive To ZIP Archive',
                133: 'Convert To Zip.',
                134: 'Change save path...',
                135: 'Change where the compress button leads the saved file to.',
                136: 'Edit Slot 1 Tileset',
                137: 'Edit Slot 1 Tileset',
                138: 'Change Objects Path...',
                139: 'Set a different folder to load the objects from',
                },
            'Objects': {
