    ...
    def InitAsEnglish(self):
        ...
        self.strings = {
            ...
            'ZonesDlg': {
                ...
                50: 'Lower Bounds:',
                51: '[b]Lower Bounds:[/b][br]Controls the maximum distance magnitude the player can be at from the bottom edge of the screen to move the camera downwards. One block = 16 units.[br][br]Higher positive values mean it is easier to scroll downwards.[br]Lower positive values mean it is harder to scroll downwards.[br]Values lower than "8" (including negative values) will function the same as the value "8", therefore it is impossible to make scrolling downwards impossible.[br][br]Very high values (larger than the screen height) with a low positive "Upper Bounds" value make scrolling upwards impossible.',
                52: 'Audio',
                53: 'Background Music:',
