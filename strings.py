    ...
    def InitAsEnglish(self):
        ...
        self.strings = {
            ...
            'ZonesDlg': {
                ...
                47: 'Bounds',
                48: 'Upper Bounds:',
                49: '[b]Upper Bounds:[/b][br]Controls how close the player needs to be to the top edge of the screen to move the camera upwards. Value of 16 = one block.[br][br]Value "0": 5 blocks away from the top edge of the screen[br]Positive values: Easier to scroll upwards[br]Negative values: Harder to scroll upwards (-80 is the top edge of the screen)[br][br]Very high values (larger than the screen height) cause instant death upon screen scrolling.[br]Very negative values prevent the screen from scrolling upwards at all.',
                50: 'Lower Bounds:',
                51: '[b]Lower Bounds:[/b][br]Controls how close the player needs to be to the bottom edge of the screen to move the camera downwards. Value of 16 = one block.[br][br]Value "0": 4.5 blocks away from the bottom edge of the screen[br]Positive values: Harder to scroll downwards (72 is the bottom edge of the screen)[br]Negative values: Easier to scroll downwards[br][br]Very high values prevent the screen from scrolling downwards at all.[br]Very negative values (larger than the screen height) cause instant death upon screen scrolling.',
                52: 'Audio',
                53: 'Background Music:',
                ...
                71: '[b]Lakitu Upper Bounds:[/b][br]Used instead of Upper Bounds when at least one player is riding a Lakitu cloud.[br][br]The values are a little different from the regular Upper Bounds setting: value "0" represents 5.5 blocks away from the top edge of the screen, and the edge is at -88.',
                72: 'Lakitu Lower Bounds:',
                73: '[b]Lakitu Lower Bounds:[/b][br]Used instead of Lower Bounds when at least one player is riding a Lakitu cloud.[br][br]The values are a little different from the regular Lower Bounds setting: value "0" represents 5.5 blocks away from the bottom edge of the screen, and the edge is at 88.',
                74: 'Enable Upward Scrolling',
                75: '[b]Enable Upward Scrolling:[/b][br]If not checked, the screen won\'t scroll upwards unless the player uses a Propeller Suit or Block. Always checked in the retail game.',
                76: 'Flags',
                77: (
