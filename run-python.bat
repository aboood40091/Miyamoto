...
powershell -Command "Invoke-WebRequest https://raw.githubusercontent.com/aboood40091/Miyamoto/master/miyamotodata/spritedata.xml -OutFile miyamotodata/spritedata.xml"
echo Done!
...
powershell -Command "Invoke-WebRequest https://raw.githubusercontent.com/aboood40091/Miyamoto/master/miyamotodata/spritecategories.xml -OutFile miyamotodata/spritecategories.xml"
echo Done!
